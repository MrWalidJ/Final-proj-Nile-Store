...
const Cart = () => {
  ...
  return (
    <div className="row my-3">
        ...
        <ul className="list-group ">
          {cart.map((prod) => (
            <li className="row m-3 " key={prod.id} aria-current="true">
              ...
              <div className="col-md-2">{prod.price} NIS</div>
              <div className="col-md-2">
      ...
      <div className="col-md-3 bg-dark text-light " style={{ height: "86vh" }}>
        <h4 className="m-3"> Subtotal ({cart.length}) items </h4>
        <h5 className="m-3"> Total: {total} NIS </h5>
      </div>
    </div>
  );
};
